          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
                We believe shopping should be personal, sustainable, and joyful.
                That's why we've built a platform that puts relationships
                first—between customers and brands, between people and products,
                and between commerce and community.
              </p>
